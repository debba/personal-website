...
export const Header = () => {
    ...
    return (
        <nav ref={navRef}
             className="border-b-2 border-secondary-color dark:border-b-0 flex fixed max-lg:landscape:relative w-full items-center justify-between z-10 flex-wrap bg-white dark:bg-extra-dark p-4">
