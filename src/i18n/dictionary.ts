export const DICTIONARY: Record<string, {
    ...
    en: {
        ...
        section_contactme_maxchars: 'Max.  {{ total }}  characters',
        section_contactme_remainingchars: 'remaining:  {{ total }}',
    ...
    it: {
        ...
        section_contactme_maxchars: 'Massimo {{ total }} caratteri',
        section_contactme_remainingchars: 'rimanenti:  {{ total }}',
