                    ...
                    <div className="relative sm:py-16 lg:py-0">
                        ...
                        <div className={"relative text-center mt-5"}>
                            <a href={githubData.html_url} target={"_blank"}
                               className={`bg-white text-gray-800 hover:bg-slate-500 hover:text-white hover:border hover:border-white font-bold py-2 px-4 rounded inline-flex items-center`} rel="noreferrer">
