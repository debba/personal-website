        ...
        <section id="project" className="py-3 md:py-[100px]">
            ...
            <div className="relative py-16 sm:py-24">
                <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
                    <div className="relative sm:py-16 lg:py-0">
                            ...
                            <div className="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
                                {
                                    data.image && (
                                        <Image loading={"lazy"} className="absolute inset-0 h-full w-full object-cover"
                                               layout={"fill"} src={data.image} alt={data.short_description}/>
                                    )
                                }
                        ...
                        <div className={"relative text-center mt-5"}>
                            <a href={githubData.html_url} target={"_blank"}
                               className={`bg-white text-gray-800 hover:bg-slate-500 hover:text-white hover:border hover:border-white font-bold py-2 px-0 md:px-4 rounded inline-flex items-center`} rel="noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" className={`fill-current w-4 h-4 mr-2`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <div className="relative mx-auto max-w-md px-0 md:px-4 sm:max-w-3xl sm:px-6 lg:px-0">
                            ...
                            <div className="relative max-w-4xl mx-auto">
                                <dl className="rounded-lg bg-slate-800 shadow-lg sm:grid sm:grid-cols-3">
                                    ...
                                    <div
                                        ...
                                        <dt className="order-2 mt-2 text-lg leading-6 font-medium  text-gray-500 font-roboto">OPEN ISSUES</dt>
                                        <dd className="order-1 text-5xl font-extrabold text-gray-300 font-roboto">
