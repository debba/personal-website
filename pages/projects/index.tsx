                ...
                <div className="relative">
                    <div className="mt-12 mx-auto max-w-md px-4 grid gap-8 sm:max-w-lg sm:px-6 lg:px-8 lg:grid-cols-3 lg:max-w-7xl">
                        {getProjects().map((project) => (
                            <div key={project.github_name} className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                                    ...
                                    <div className="flex-1">
                                        <Link href={`/projects/${project.github_name}`} locale={g11nLocale}>
                                            <a className="block mt-2">
                                                ...
                                                <p className="mt-3 text-sm  font-roboto text-gray-100">{project.short_description}</p>
                                            </a>
                                        </Link>
                                    </div>
                                </div>
